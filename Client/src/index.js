...
function fetchExistingUser(){
  fetch(USERS_URL)
  .then(res => res.json()).then(json => isExistingUser(json))
}

function isExistingUser(json){
...
let randLocations = [
  ...
  ["speeding",[55.87263,-4.2660584]],
  ["horse_head",[45.6208283,12.5372125,2013]],
  ["murder_scene",[55.9735307,-3.1727109,2012]],
  ["yoga",[51.3646871,1.042568,2009]],
  ["screen_clean",[54.1404008,-4.5615523]],
  ["car_crash",[57.9286927,-5.1977147]],
